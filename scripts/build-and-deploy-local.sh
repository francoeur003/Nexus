...
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString 2.0.61" "$APP/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Set :CFBundleVersion 2061" "$APP/Contents/Info.plist"
